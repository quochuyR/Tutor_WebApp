            ...
            <div class="col-lg-10 mx-auto">
                <div class="career-search mb-60">
                    ...
                    <div class="filter-result">
                        ...
                        <div
                            class="job-box d-md-flex align-items-center justify-content-between mb-30  position-relative">
                            ...
                            <div class="d-md-none d-block pb-4 pb-md-0">
                                <ul class="d-flex justify-content-end ">
                                    <li><a class="text-reset text-decoration-none" href="#"><i
                                                class="fas fa-eye me-1"></i> Xem</a></li>

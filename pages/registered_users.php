                                                            ...
                                                            <ul class="d-md-flex flex-md-column flex-wrap my-md-2 ff-open-sans p-0">
                                                                <li class="text-sub text-muted">
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <span class="subject-span <?= $resultSubTopic['approval'] === 1 ? "text-success" : "" ?>" data-id="<?= $resultSubTopic['id'] ?>"><?= $resultSubTopic['topicName'] ?></span> |
                                                                    <?php
                                                                    }
                                                                ...
                                                                <li class="text-muted py-1">
                                                                    <i class="fa-solid fa-user-graduate"></i> <?= $_register_user["job"] ?>
                                                                </li>
                                                        ...
                                                        <div class="job-right my-4 flex-shrink-0 d-none d-md-flex">
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                    <li class="py-1">
                                                                        <div class="dropdown-item" data-bs-toggle="modal" data-bs-target="#user-detail-<?= $user["username"] ?>" style="cursor: pointer"><i class="fas fa-eye pe-2"></i> Xem</div>
                                                                    </li>
                                                                    <li class="py-1">
                ...
                function addSchedule(event_approval) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            else if (data.status === '0') $(id_modal).closest(".job-box").removeClass("bg-approval");

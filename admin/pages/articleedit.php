        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row  align-items-center pb-4">
                    <div class="col-auto">
                        <button type="submit" class="btn btn-primary" id="saveArticleEdit">Lưu lại</button>
                    </div>
                    <div class="col-auto">
                        <div class="btn-group">
                            <a href="articleinsert" class="btn btn-secondary" id="saveNewArticleEdit">Lưu lại và mới</a>
                            <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                                <span class="visually-hidden">Toggle Dropdown</span>
                            </button>
                            <ul class="dropdown-menu mt-5 " aria-labelledby="dropdownMenuReference">
                                <li><a class="dropdown-item" href="article" id="saveCloseArticleEdit">Lưu lại và đóng</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="uploadImage" role="tabpanel" aria-labelledby="uploadImage-tab">
                                <div class="row mb-3 pt-1 pb-1 form-UploadImage-Small">
                                    <div class="col-4 form-image-up">
                                        <img src="https://t4.ftcdn.net/jpg/00/54/09/87/360_F_54098766_67IO5AhpMRUmThLAxM3vEJUWIRuJYGKU.jpg" alt="">
                                    </div>
                                    <div class="col-12 align-item-center form-input-up">

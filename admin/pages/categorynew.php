                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row  align-items-center pb-4">
                            <div class="col-auto">
                                <button type="submit" class="btn btn-primary" id="saveCategory">Lưu lại</button>
                            </div>
                            <div class="col-auto">
                                <div class="btn-group">
                                    <a href="" class="btn btn-secondary" id="saveNewCategory">Lưu lại và mới</a>
                                    <button type="button" class="btn btn-secondary dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference" data-bs-toggle="dropdown" aria-expanded="false" data-bs-reference="parent">
                                        <span class="visually-hidden">Toggle Dropdown</span>
                                    </button>
                                    <ul class="dropdown-menu mt-5 " aria-labelledby="dropdownMenuReference">
                                        <li><a class="dropdown-item" href="category" id="saveCloseCategory">Lưu lại và đóng</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="col-8">
                            <div class="mb-3">
                                <label for="litleCategory" class="form-label"><h4><b>Tên danh mục</b></h4></label>
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <textarea id="aboutCategory" placeholder="Nội dung..."></textarea>
                            </div>
                            <div class="col-4">
                                <h4 class="text-center mb-2"><b>Tùy chỉnh</b></h4>
                                <div class="mb-3">
                                    <label for="position_show" class="form-label">Vị trí hiển thị</label>
                                    <select id="position_show" class="form-select">
                                ...
                                <div class="mb-3">
                                    <label for="statusCategory" class="form-label">Trạng thái</label>
                                    <select id="statusCategory" class="form-select">

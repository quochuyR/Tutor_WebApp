            ...
            function values(iterable) {
                if (iterable) {
                    ...
                    if (!isNaN(iterable.length)) {
                        var i = -1,
                            next = function next() { for (; ++i < iterable.length;) { if (hasOwn.call(iterable, i)) return next.value = iterable[i], next.done = !1, next; } return next.value = undefined, next.done = !0, next; };
                    ...
                    $(".logout").on('click', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function success(data) {
                                ...
                                if (window.location.pathname.includes("saved_tutors")) location.href = "../pages/list_tutor";
            ...
            $(document).ready(function() {
                ...
                function get_filter_str(className) {
                    ...
                    $(className).each(function(i, val) {
                        ...
                        if (i === $(_this).length - 1) data += $(val).val();
                        else data += $(val).val() + ', '; // console.log($(val).val(), "val")
                    });
                    return data.trim();
                    return;
                }
            ...
            $(document).ready(function() {
                ...
                $("#save-tutor").on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        success: function success(data) {
                            if (data.insert !== "fail") $("#save-tutor").text(data.data);
                            else {
                                Toastify({
    ...
    (() => {
        ...
        $(document).ready(function() {
            ...
            $("#sentcontact").on('click', function(event) {
                ...
                var email = $("#email").val();
                var phone = $("#phone").val();
                var content = $("#content").val(); //kiểm tra tính hợp lệ của dữ liệu và báo lỗi
                ...
                if (!checkfullname) {
                    var fullnameError = "";
                    if (fullname.length == 0) fullnameError = 'Vui lòng nhập tên của bạn!';
                    else fullnameError = 'Tên của bạn của bạn quá dài!';
                    ...
                    var success = "Yêu cầu của bạn đã được thực hiện. Vui lòng chờ điện thoại chúng tôi sẽ liên hệ bạn."; //dữ liệu hợp lệ tiến hành post qua file contact.php
                    ...
                    $.ajax({
                        ...
                        success: function success() { // alert("Contact");
                        }
                    ...
                    $('#email').attr('value', '');
                    $('#phone').attr('value', '');
                    $('#content').attr('value', ''); //mở notification - thong bao gửi yêu cầu thành công
